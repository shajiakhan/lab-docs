...
>Use the below values/inputs [while following the instructions on how to add static routes on a router in OpenStack Dashboard here](../../tasks/openstack/add-static-routes.md).
